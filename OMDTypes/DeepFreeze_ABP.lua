...
---@class UDeepFreeze_ABP_C : UOMDTrapAnimInstance
...
function UDeepFreeze_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UDeepFreeze_ABP_C:ExecuteUbergraph_DeepFreeze_ABP(EntryPoint) end
