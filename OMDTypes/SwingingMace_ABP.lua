...
---@class USwingingMace_ABP_C : UOMDTrapAnimInstance
...
function USwingingMace_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function USwingingMace_ABP_C:ExecuteUbergraph_SwingingMace_ABP(EntryPoint) end
