...
---@class UHaymaker_ABP_C : UOMDTrapAnimInstance
...
function UHaymaker_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UHaymaker_ABP_C:ExecuteUbergraph_Haymaker_ABP(EntryPoint) end
