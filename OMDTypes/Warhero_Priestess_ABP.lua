...
---@class UWarhero_Priestess_ABP_C : UOMDWarHeroAnimInstance
...
UWarhero_Priestess_ABP_C = {}

---@param AnimGraph FPoseLink
function UWarhero_Priestess_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UWarhero_Priestess_ABP_C:ExecuteUbergraph_Warhero_Priestess_ABP(EntryPoint) end
