...
---@class UMinion_Standard_Biped_ABP_C : UOMDAIAnimInstance
...
UMinion_Standard_Biped_ABP_C = {}

---@param AnimGraph FPoseLink
function UMinion_Standard_Biped_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UMinion_Standard_Biped_ABP_C:ExecuteUbergraph_Minion_Standard_Biped_ABP(EntryPoint) end
