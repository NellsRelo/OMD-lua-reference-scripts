...
---@class UWarhero_Knight_ABP_C : UOMDWarHeroAnimInstance
...
UWarhero_Knight_ABP_C = {}

---@param AnimGraph FPoseLink
function UWarhero_Knight_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UWarhero_Knight_ABP_C:ExecuteUbergraph_Warhero_Knight_ABP(EntryPoint) end
