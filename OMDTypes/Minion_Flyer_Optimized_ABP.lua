...
---@class UMinion_Flyer_Optimized_ABP_C : UOMDAIAnimInstance
...
UMinion_Flyer_Optimized_ABP_C = {}

---@param AnimGraph FPoseLink
function UMinion_Flyer_Optimized_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UMinion_Flyer_Optimized_ABP_C:ExecuteUbergraph_Minion_Flyer_Optimized_ABP(EntryPoint) end
