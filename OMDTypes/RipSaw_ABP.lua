...
---@class URipSaw_ABP_C : UOMDTrapAnimInstance
...
function URipSaw_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function URipSaw_ABP_C:ExecuteUbergraph_RipSaw_ABP(EntryPoint) end
