...
---@class URollingBoulder_WM_ABP_C : UOMDTrapAnimInstance
...
URollingBoulder_WM_ABP_C = {}

---@param AnimGraph FPoseLink
function URollingBoulder_WM_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function URollingBoulder_WM_ABP_C:ExecuteUbergraph_RollingBoulder_WM_ABP(EntryPoint) end
