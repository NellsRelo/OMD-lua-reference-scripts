...
---@class UMinion_Facultative_Biped_Optimized_ABP_C : UOMDAIAnimInstance
...
UMinion_Facultative_Biped_Optimized_ABP_C = {}

---@param AnimGraph FPoseLink
function UMinion_Facultative_Biped_Optimized_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UMinion_Facultative_Biped_Optimized_ABP_C:ExecuteUbergraph_Minion_Facultative_Biped_Optimized_ABP(EntryPoint) end
