...
---@class UDartSpitter_ABP_C : UOMDTrapAnimInstance
...
function UDartSpitter_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UDartSpitter_ABP_C:ExecuteUbergraph_DartSpitter_ABP(EntryPoint) end
