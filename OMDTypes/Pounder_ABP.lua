...
---@class UPounder_ABP_C : UOMDTrapAnimInstance
...
function UPounder_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UPounder_ABP_C:ExecuteUbergraph_Pounder_ABP(EntryPoint) end
