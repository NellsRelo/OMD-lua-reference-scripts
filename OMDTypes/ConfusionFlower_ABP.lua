...
---@class UConfusionFlower_ABP_C : UOMDTrapAnimInstance
...
---@field ['Fire Rotation'] FRotator
UConfusionFlower_ABP_C = {}

---@param AnimGraph FPoseLink
function UConfusionFlower_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UConfusionFlower_ABP_C:ExecuteUbergraph_ConfusionFlower_ABP(EntryPoint) end
