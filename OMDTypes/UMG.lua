...
---@param SelectInfo ESelectInfo::Type
function UComboBoxString:SetSelectedOption(Option, SelectInfo) end
---@param Index int32
---@param SelectInfo ESelectInfo::Type
function UComboBoxString:SetSelectedIndex(Index, SelectInfo) end
---@param Option FString
---@return boolean
