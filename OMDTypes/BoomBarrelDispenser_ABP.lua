...
---@class UBoomBarrelDispenser_ABP_C : UOMDTrapAnimInstance
...
UBoomBarrelDispenser_ABP_C = {}

---@param AnimGraph FPoseLink
function UBoomBarrelDispenser_ABP_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UBoomBarrelDispenser_ABP_C:ExecuteUbergraph_BoomBarrelDispenser_ABP(EntryPoint) end
