...
---@class UABP_OMDTrap_FlipTrap_WM_C : UOMDTrapAnimInstance
...
UABP_OMDTrap_FlipTrap_WM_C = {}

---@param AnimGraph FPoseLink
function UABP_OMDTrap_FlipTrap_WM_C:AnimGraph(AnimGraph) end
function UABP_OMDTrap_FlipTrap_WM_C:EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_OMDTrap_FlipTrap_WM_AnimGraphNode_TransitionResult_2B7592574A0A42A485F7DEAE56E3C4A6() end
---@param EntryPoint int32
function UABP_OMDTrap_FlipTrap_WM_C:ExecuteUbergraph_ABP_OMDTrap_FlipTrap_WM(EntryPoint) end
